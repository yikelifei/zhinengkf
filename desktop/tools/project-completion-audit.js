...
const CONTRACTS = Object.freeze([
  ...
  },
  {
    ...
    title: "External evidence reopens distinct package artifacts and reruns content plus signature verification",
    file: "desktop/tools/external-evidence-bundle.js",
    patterns: [
      /requestedStat\.isSymbolicLink\(\) \|\| !requestedStat\.isFile\(\)/,
      /stat\.nlink !== 1n/,
