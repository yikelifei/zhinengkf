...
test("sku image problems can be searched and exported as the visible repair list", () => {
  ...
  assert.match(page, /function sortSkuImageProblems\(problems: SkuImageProblem\[\], sortBy: string\)/);
  ...
  assert.match(page, /return sortSkuImageProblems\(filtered, skuImageProblemSort\)/);
  assert.match(page, /\[skuImageProblemSearch, skuImageProblemSeverityFilter, skuImageProblemSort, skuImageProblems\]/);
