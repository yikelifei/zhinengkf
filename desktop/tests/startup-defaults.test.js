...
test("double click startup bat files use stable launcher scripts", () => {
  ...
  assert.match(stableStart, /start "Smart Kefu Services" \/min/);
  ...
  assert.match(stableKeepalivePs1, /Start-Process `[\s\S]*-FilePath "cmd\.exe"/);
  assert.match(stableKeepalivePs1, /-ArgumentList @\("\/d", "\/c", "node \$StableRuntimeLauncherArgument"\)/);
  ...
  assert.doesNotMatch(stableKeepalivePs1, /RedirectStandardOutput/);
  assert.doesNotMatch(stableKeepalivePs1, /RedirectStandardError/);
