...
export const appConfig = {
  ...
  wechatWorkDefaultWechatAccountId: process.env.WECHAT_WORK_DEFAULT_WECHAT_ACCOUNT_ID || "",
  wechatWorkDefaultConversationId: process.env.WECHAT_WORK_DEFAULT_CONVERSATION_ID || "",
  wechatWorkDefaultCustomerId: process.env.WECHAT_WORK_DEFAULT_CUSTOMER_ID || "",
