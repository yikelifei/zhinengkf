...
export class TrainingController {
  ...
  @Post("chat-imports")
  importChat(@Body() payload: { name?: string; source?: string; channel?: "wechat" | "xiaohongshu" | "douyin" | "manual"; agentId?: string; text: string }) {
    return this.training.importChat(payload);
  }

  @Get("samples")
  listSamples(@Query("agentId") agentId?: string) {
    return this.training.listSamples(agentId);
  }
