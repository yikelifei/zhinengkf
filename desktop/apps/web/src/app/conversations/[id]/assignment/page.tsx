import { ConversationAssignmentPage, conversationNavigationFromSearchParams, type ConversationNavigationSearchParams } from "../../../../features/conversations";
...
export default async function Page({ params, searchParams }: PageProps) {
  ...
  return (
    <FeatureRouteShell routeId="conversationAssignment">
      <ConversationAssignmentPage key={id} conversationId={id} identityFilters={identityFilters} navigation={navigation} />
    </FeatureRouteShell>
  );
}
