import { TrainingKnowledgePage } from "../../../features/training/training-knowledge-page";
...
export default async function Page({ searchParams }: PageProps) {
  ...
  return (
    <FeatureRouteShell routeId="trainingKnowledge">
      <TrainingKnowledgePage identityFilters={identityFilters} />
    </FeatureRouteShell>
  );
}
