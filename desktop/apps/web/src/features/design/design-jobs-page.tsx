...
export function DesignJobsPage() {
  ...
  const refreshJobs = useCallback(async () => {
    ...
    try { const records = await getVerifiedDesignJobs(); setJobs(records); setSelectedId((current) => current && records.some((job) => job.id === current) ? current : ""); }
